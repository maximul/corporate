                    ...
                    <tbody>
                        @foreach($articles as $article)
                            <tr>
                                ...
                                <td class="align-left">{!! Html::link(route('articles.edit', ['articles' => $article->alias]), $article->title, ['alt' => $article->title]) !!}</td>
                                ...
                                <td>
                                    {!! Form::open([
                                        'url' => route('articles.destroy', ['articles' => $article->alias]),
