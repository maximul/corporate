<div id="content-page" class="content group">
    <div class="hentry group">
        ...
        {!! Form::open([
            'url' => (isset($article->id)) ? route('articles.update', ['articles' => $article->alias]) : route('articles.store'),
            'class' => 'contact-form',
            'method' => 'POST',
        ...
        <ul>
            ...
            @if(isset($article->img->path))
                <li class="textarea-field">
                    ...
                    {!! Html::image(asset(config('settings.theme')).'/images/articles/'.$article->img->path, '', ['style' => 'width:350px;']) !!}
