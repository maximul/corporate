...
<head>
    ...
    <link rel="stylesheet" id="jquery-ui-css" href="{{ asset(config('settings.theme')) }}/css/jquery-ui.css" type="text/css" media="all" />
...
<!-- START BODY -->
<body class="no_js responsive {{ (Route::currentRouteName() == 'adminIndex') ? 'page-template-home-php' : '' }} stretched">
